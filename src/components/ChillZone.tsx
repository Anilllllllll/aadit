...
export default function ChillZone({ onNext }: ChillZoneProps) {
  const tracks: Track[] = (textConfig.chillZone.tracks || [])
    .map((track: Track, index: number) => ({
      ...track,
      id: track.id ?? index + 1,
    }))
    .filter((track: Track) => Boolean(track.src));
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative rounded-xl p-3 sm:p-4 shadow-xl border-b-6 sm:border-b-8 border-r-6 sm:border-r-8 overflow-hidden" style={{
                        ...
                        {/* Cassette Label Area */}
                        <div className="bg-[#eee4ff] rounded-lg p-2 sm:p-3 relative overflow-hidden border-2 border-white/40 shadow-sm z-20">
                        ...
                        <div className="mt-2 sm:mt-4 relative px-2 sm:px-4 flex items-center justify-between z-20">
                          ...
                          <button className="relative group/btn flex items-center justify-center w-10 sm:w-14 h-10 sm:h-14 bg-primary text-white rounded-full shadow-[0_2px_0_rgb(120,90,200)] sm:shadow-[0_4px_0_rgb(120,90,200)] active:shadow-none active:translate-y-1 transition-all duration-150 transform hover:scale-110">
                          ...
                          {/* Favorite Button */}
                          <button className="text-[#c5a995] hover:text-primary transition-colors duration-200 p-1 sm:p-2 rounded-full hover:bg-[#eee4ff]/50">
