    ...
    <div className="app">
      ...
      {showIntro && (
        <motion.div 
          ...
          style={{
            zIndex: 9999,
            background: 'linear-gradient(135deg, #F6F1FF 0%, #EEE4FF 25%, #E6D6FF 50%, #EEE4FF 75%, #F6F1FF 100%)'
          }}
          initial={{ opacity: 1 }}
          exit={{ opacity: 0 }}
      ...
      <style>{`
        ...
        .aeroplane-intro-overlay {
          ...
          gap: 40px;
          background: linear-gradient(135deg, #F6F1FF 0%, #EEE4FF 50%, #E6D6FF 100%);
          opacity: 1;
        ...
        .aeroplane-img {
          ...
          filter: drop-shadow(0 6px 20px rgba(157, 122, 232, 0.45));
          z-index: 10;
          position: relative;
        ...
        .cloud {
          ...
          height: auto;
          z-index: 1;
          filter: drop-shadow(0 4px 12px rgba(140, 104, 222, 0.18));
          opacity: 0.85;
        ...
        .typing-text {
          ...
          position: relative;
          z-index: 10;
          text-shadow: 0 2px 8px rgba(126, 99, 200, 0.2);
        }
        ...
        .dreamy-bg {
          ...
          inset: 0;
          background: 
            radial-gradient(circle at 20% 80%, rgba(199, 167, 255, 0.35) 0%, transparent 50%),
            radial-gradient(circle at 80% 20%, rgba(238, 228, 255, 0.45) 0%, transparent 50%),
            radial-gradient(circle at 40% 40%, rgba(186, 201, 255, 0.2) 0%, transparent 50%),
        ...
        .particle {
          ...
          width: 4px;
          height: 4px;
          background: radial-gradient(circle, rgba(157, 122, 232, 0.6), rgba(157, 122, 232, 0.2));
          border-radius: 50%;
        ...
        .grid-overlay {
          ...
          z-index: 2;
          background-image: 
            linear-gradient(rgba(199, 167, 255, 0.1) 1px, transparent 1px),
            linear-gradient(to right, rgba(140, 104, 222, 0.08) 1px, transparent 1px);
        ...
        .icon {
          position: absolute;
          opacity: 0.85;
          filter: drop-shadow(0 4px 12px rgba(157, 122, 232, 0.18));
        ...
        .heart-1, .heart-2, .sparkle-text-1, .sparkle-text-2 {
          ...
          font-size: 24px;
          opacity: 0.6;
          filter: drop-shadow(0 2px 8px rgba(157, 122, 232, 0.22));
        }
